...
import { trustStatement } from '../data/pricing';
import Button from './Button';

function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 lg:pt-20 overflow-hidden bg-gradient-to-b from-neutral-50 to-white">
      ...
      <div className="container-custom relative py-20 lg:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-neutral-600 mb-10 max-w-3xl mx-auto leading-relaxed animate-slide-up delay-100">
            Professional websites, online booking, e-commerce solutions, and reliable business laptops — all from one affordable technology partner.
          </p>
